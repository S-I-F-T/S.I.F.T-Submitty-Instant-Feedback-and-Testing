...
welcome_frame = ctk.CTkFrame(master = root)
...
button_frame_1 = ctk.CTkFrame(master= welcome_frame)
...
how_to_button = ctk.CTkButton(master = button_frame_1, text = "How to Use", 
                              font = ctk.CTkFont(family = 'Calibri', size = 15, weight = "bold"),
                               width = 255, height = 55, command = lambda: switch_frame('how_to_frame'))

how_to_button.pack(side=ctk.RIGHT, padx = 15)

button_frame_2 = ctk.CTkFrame(master= welcome_frame)
button_frame_2.pack(pady = 12, padx = 10)

about_button = ctk.CTkButton(master = button_frame_2, text = "About",
                             font = ctk.CTkFont(family='Calibri', size=15, weight = "bold"),
                              width = 255, height = 55, command = lambda: switch_frame('about_frame'))
about_button.pack(side=ctk.LEFT, padx = 15)

settings_button = ctk.CTkButton(master = button_frame_2, text = "Settings",
                                font = ctk.CTkFont(family='Calibri', size=15, weight = "bold"),
                                 width = 255, height = 55, command = lambda: switch_frame('settings_frame'))
settings_button.pack(side=ctk.RIGHT, padx = 15)

quit_frame = ctk.CTkFrame(master = welcome_frame)
quit_frame.pack(pady = 12, padx = 10)

quit_button = ctk.CTkButton(master = quit_frame, text = "Quit",
                                font = ctk.CTkFont(family='Calibri', size=15, weight = "bold"),
                                 width = 255, height = 55, command = root.quit)
quit_button.pack(side=ctk.BOTTOM, pady = 10)

# File select page
file_select_frame = ctk.CTkFrame(master = root)

file_select_title_frame = ctk.CTkFrame(master = file_select_frame)
...
file_select_choose_frame = ctk.CTkFrame(master = file_select_frame)
...
your_files_button = ctk.CTkButton(master = file_select_choose_frame, text = "Select your file(s)", 
                                  font = ctk.CTkFont(family='Calibri', size=15, weight = "bold"),
                                   width = 255, height = 55, command = select_user_file)
...
expected_files_button = ctk.CTkButton(master = file_select_choose_frame, text = "Select expected output file(s)",
                                        font = ctk.CTkFont(family='Calibri', size=15, weight = "bold"),
                                         width = 255, height = 55, command = select_expected_file)
...
file_select_compare_button = ctk.CTkButton(master = file_select_frame, text = "Compare",
                                            font = ctk.CTkFont(family='Calibri', size=15, weight = "bold"),
                                             width = 100, height = 40, command= lambda: switch_frame('comparison_frame'))
file_select_compare_button.pack(side=ctk.BOTTOM, pady = 10)

# Comparison page
comparison_frame = ctk.CTkFrame(master = root)

comparison_title_frame = ctk.CTkFrame(master = comparison_frame)
...
settings_language_frame = ctk.CTkFrame(master = settings_frame)
...
settings_theme_frame = ctk.CTkFrame(master = settings_frame)
...
# About page
about_frame = ctk.CTkFrame(master = root)
...
# How to use page
how_to_frame = ctk.CTkFrame(master = root)
